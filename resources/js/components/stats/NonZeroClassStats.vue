...
export default {
                ...
                chart: {
                    events: {
                        load() {
                            ...
                            vm.getZeroClassChartData();
                        }
                    }
                },
                title: {
                    text: trans('messages.non-zero-classes')
                },
                yAxis: {
                    title: {
                        text: trans('messages.number-of-classes')
                    }
                },
                xAxis: {
                    categories: []
    ...
    methods: {
        getZeroClassChartData: function(){
            this.isLoading = true;
            axios.get(route('stats_data.non_zero_class').url(), {
